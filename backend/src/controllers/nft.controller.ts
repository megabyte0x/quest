...
export const getArtHistory = asyncWrap(async (req: Request, res: Response, _next: NextFunction) => {
    try {
...
export const getTokenId = asyncWrap(async (req: Request, res: Response, _next: NextFunction) => {
    try {
        const body = req.body;
        ...
        // TODO: Change this to async await as it's more cleaner and understandable
        axios
            .request(options)
...
export const getGenerateArt = asyncWrap(async (req: Request, res: Response, _next: NextFunction) => {
    try {
...
export const getAllNFT = asyncWrap(async (req: Request, res: Response, _next: NextFunction) => {
    try {
        const body = req.body;
        const address = body.address;
        const contractAddressIndex = body.contractAddressIndex;
...
export const getMint = asyncWrap(async (req: Request, res: Response, _next: NextFunction) => {
    try {
        const body = req.body;
...
export const getUploadImage = asyncWrap(async (req: Request, res: Response, _next: NextFunction) => {
